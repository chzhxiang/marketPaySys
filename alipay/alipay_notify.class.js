...
AlipayNotify.prototype.getSignVeryfy = function(para_temp, sign){
    ...
    //prestr = encodeURIComponent(prestr);
    ...
    if(sign_type == "MD5"){
        ...
        var publicPem = fs.readFileSync(this.alipay_config['cert_file']);
        var publicKey = publicPem.toString('ascii');
        var verifyob = crypto.createVerify('RSA-SHA1');
         isSgin= verifyob.verify(publicKey, new Buffer(sign, 'base64'), 'base64');
    }
